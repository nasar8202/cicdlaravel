        ...
        <div class="col-lg-12">
            <div class="profile">
                <div class="profile-img">
                    <img id="dp" src="{{ $user->picture }}" class="profile-user-img img-fluid img-circle admin_picture"
                    ...
                    <div class="col-lg-6">
                        <div class="mb-3 mt-3">
                            ...
                            <input type="text" class="form-control" id="name" placeholder="John Doe" name="name"
                                minlength="3" value="{{ $user->name }}" maxlength="180" required />
                        </div>
                    </div>
                    <div class="col-lg-6">
                        <div class="mb-3 mt-3">
                            ...
                            <input type="email" class="form-control" id="email" placeholder="Enter your email"
                                name="email" minlength="3" maxlength="180" value="{{ $user->email }}" readonly />
                        </div>
                    </div>
                    <div class="col-lg-6">
                        <div class="mb-3 mt-3">
                            ...
                            <input type="number" class="form-control" id="mobile" placeholder="Mobile"
                                value="{{ $user->mobile_number }}" name="mobile_number" minlength="3" maxlength="180"
                                required />
                        </div>
                    </div>
                    <div class="col-lg-6">
                        <div class="mb-3 mt-3">
                            ...
                            <input type="number" class="form-control" id="whatsapp" placeholder="Whatsapp"
                                value="{{ $user->whatsapp_number }}" name="whatsapp_number" minlength="3" maxlength="180"
                                required />
                        </div>
                    </div>
                    <div class="col-lg-12">
                        <div class="mb-3 mt-3">
                            ...
                            <input type="text" class="form-control" id="address" placeholder="Address"
                                value="{{ $user->dialing_code }}" name="address" minlength="3" maxlength="1000" required />
                        </div>
                    </div>
                    <div class="col-lg-6">
                        <div class="mb-3 mt-3">
                    ...
                    <div class="col-lg-12">
                        <div class="form-check-inline">
                            <label class="form-check-label"> <input type="checkbox" class="form-check-input"
                                    ...
                                    @if ($user->update_details == 1) checked @endif />Update details in all property
                                listings
                            </label>
                        </div>
                    </div>
