...
@section('content')
    ...
    <form action="{{ route('userUpdateInfo') }}" id="AdminInfoForm" method="post">
                    ...
                    <div class="col-lg-6">
                        <div class="mb-3 mt-3">
                            ...
                            <input type="email" class="form-control" id="email" placeholder="Enter your email"
                                name="email" minlength="3" maxlength="180" value="{{ Auth::user()->email }}" readonly />
                        </div>
                    </div>
                    <div class="col-lg-6">
                        <div class="mb-3 mt-3">
    ...
    <script>
        $(document).ready(function() {
            ...
            $('#inputCountry').on('change', function() {
                ...
                if (countryId) {
                    var ajaxUrl = appUrl + 'user/get-states/' + countryId;
                    $.ajax({
                        url: ajaxUrl,
                        type: 'GET',
